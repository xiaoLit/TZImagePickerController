...
//        UIBarButtonItem *backItem = [[UIBarButtonItem alloc] initWithTitle:[NSBundle tz_localizedStringForKey:@"Back"] style:UIBarButtonItemStylePlain target:self action:@selector(navLeftBarButtonClick)];
        UIBarButtonItem *backItem = [[UIBarButtonItem alloc] initWithTitle:tzImagePickerVc.backBtnChooseAlbumTitleStr style:UIBarButtonItemStylePlain target:self action:@selector(navLeftBarButtonClick)];
